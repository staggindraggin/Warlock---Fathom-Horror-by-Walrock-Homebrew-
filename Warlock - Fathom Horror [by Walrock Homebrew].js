...
AddSubClass("warlock", "the fathom horror", {
    regExpSearch : /^(((?=.*(aboleth|dagon|kraken|olhydra|cthulu))(?=.*warlock))|((?=.*(fathom|depth))(?=.*(horror|entity)))).*$/i,
    subname : "the Fathom Horror",
    source : ["WH:FH", 1],
    ...
    features : {
        "subclassfeature1" : {
            ...
            description : desc([
                ...
                "It bursts forth from extraplanar space and attempts to grasp a creature within 30 feet of me",
